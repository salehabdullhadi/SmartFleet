        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CenterLat = table.Column<decimal>(type: "decimal(9,6)", nullable: false),
                    CenterLng = table.Column<decimal>(type: "decimal(9,6)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SimNumber = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WasInsideGeofence = table.Column<bool>(type: "bit", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Vehicles", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Vehicles_Geofences_GeofenceId",
                        column: x => x.GeofenceId,
                        principalTable: "Geofences",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Vehicles_SimCards_SimCardId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Vehicles_GeofenceId",
                table: "Vehicles",
                column: "GeofenceId");

            migrationBuilder.CreateIndex(
                name: "IX_Vehicles_SimCardId",
                table: "Vehicles",
                column: "SimCardId");
        }
